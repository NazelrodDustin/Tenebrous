...
if (view_current == 4){
	...
	draw_sprite_ext(spr_battleBG, 0, drawX, drawY, (5 + randomScaleOffset) * battleBGSpriteScale, (5 + randomScaleOffset) * battleBGSpriteScale, (0.5 + random_range(-0.25, 0.25)) * battleBGSpriteRotation, battleBG, 1);
	...
	randomScaleOffset = random_range(-0.25, 0.25);
	draw_sprite_ext(spr_battleBG, 0, drawX, drawY, (3.5 + randomScaleOffset) * battleBGSpriteScale, (3.5 + randomScaleOffset) * battleBGSpriteScale, (4.5 + random_range(-1.5, 1.5)) * battleBGSpriteRotation, battleBG, 1);
	randomScaleOffset = random_range(-0.25, 0.25);
	...
	randomScaleOffset = random_range(-0.25, 0.25);
	draw_sprite_ext(spr_battleBG, 0, drawX, drawY, (2 + randomScaleOffset) * battleBGSpriteScale, (2 + randomScaleOffset) * battleBGSpriteScale, (15 + random_range(-3, 3)) * battleBGSpriteRotation, battleBG, 1);
	randomize();
	// Reset draw color
